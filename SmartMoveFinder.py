...
"""
Picks and returns a random momve.
"""
        ...
        if gs.checkmate:
            ...
            for opponentsMoves in opponentsMoves:
                ...
                if gs.checkmate:
                    ...
                    score = -turnMultiplier * score(gs.board)
        ...
        for col in range(len(gs.board[row])):
            ...
            if square != "--":
                ...
                if square[1] != "K": #no position table for king
                    if square[1] == "p":
                        piecePositionScores = piecePositionScores[square][row][col]
                    else: #for other pieces
                        piecePostionScore = piecePostionScore[square[1]][row][col]

                if square[0] == 'w':
                    score += pieceScore[square[1]] + piecePostionScore * .1
                elif square[0] == 'b':
                    score -= pieceScore[square[1]] + piecePostionScore * .1
